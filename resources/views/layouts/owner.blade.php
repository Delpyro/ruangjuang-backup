...
<head>
    ...
    <title>Owner - {{ config('app.name', 'Laravel') }}</title>
...
<div class="flex h-screen">
    <aside class="w-64 bg-white shadow-lg flex flex-col">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            {{-- ✨ SUDAH TERHUBUNG KE ROUTE DASHBOARD OWNER ✨ --}}
           ...
           <a href="{{ route('owner.users') }}" class="flex items-center px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('owner.users') ? 'bg-blue-100 text-blue-700' : '' }}">
            ...
            <a href="#" class="flex items-center px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors duration-200">
            ...
            <a href="{{ route('owner.reviews.index') }}" class="flex items-center px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('owner.reviews.*') ? 'bg-blue-100 text-blue-700' : '' }}">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="h-16 bg-white shadow flex items-center justify-between px-6 shrink-0">
            ...
            <div class="flex items-center space-x-4">
                ...
                <span class="font-medium text-gray-800">{{ auth()->user()->name ?? 'Owner' }}</span>
            </div>
        </header>
