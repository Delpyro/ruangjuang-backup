<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-xl shadow-md overflow-hidden p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Manajemen Sub Kategori Pertanyaan</h2>
        ...
        <div class="mb-4">
            <input
                ...
                placeholder="Cari nama sub kategori atau kategori induk..."
            ...
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($subCategories as $index => $subCategory)
                        <tr class="hover:bg-gray-50 transition-colors duration-150 {{ $subCategory->trashed() ? 'bg-red-50' : '' }}">
                            {{-- PENOMORAN DEFAULT LARAVEL PAGINATION --}}
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ ($subCategories->currentPage() - 1) * $subCategories->perPage() + $index + 1 }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    {{-- BLOK ICON TELAH DIHAPUS --}}
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    @if(!$subCategory->trashed())
                                        <button
                                            wire:click="openModal(true, {{ $subCategory->id }})"
                                    ...
                                    @else
                                        <button
                                            wire:click="restore({{ $subCategory->id }})"
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="delete-confirmation-title" role="dialog" aria-modal="true">
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-auto p-6">
                    ...
                    <p class="text-sm text-gray-500 text-center mb-6">Apakah kamu yakin ingin menghapus sub kategori ini? Data akan dipindahkan ke tempat sampah dan dapat dipulihkan kapan saja.</p>
