...
<script>
    ...
    document.addEventListener('livewire:load', function () {
        // Menggunakan initTinyMCE dari layout utama
    ...
    document.addEventListener('livewire:navigated', function () {
        if (tinymce.get('tinymce-content-edit')) {
            tinymce.get('tinymce-content-edit').destroy();
        }
        if (tinymce.get('tinymce-quote-edit')) {
            tinymce.get('tinymce-quote-edit').destroy();
        }
