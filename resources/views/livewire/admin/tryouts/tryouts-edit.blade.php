<div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl border border-gray-200">
    ...
    <form wire:submit.prevent="update" class="space-y-6">
        ...
        <div wire:ignore>
            ...
            <textarea id="tinymce-content-edit" rows="6" class="w-full mt-1 border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('content') border-red-500 @enderror" placeholder="Deskripsi lengkap tentang tryout...">{!! $content !!}</textarea>
        ...
        <div wire:ignore>
            ...
            <textarea id="tinymce-quote-edit" rows="3" class="w-full mt-1 border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('quote') border-red-500 @enderror" placeholder="Kutipan motivasi atau informasi tambahan...">{!! $quote !!}</textarea>
        ...
        <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
            ...
            >
                ...
                <span wire:loading.remove>Perbarui Tryout</span>
...
@push('scripts')
<script>
    // PENTING: Jika butuh upload image, sesuaikan route ini dengan dynamic role juga
