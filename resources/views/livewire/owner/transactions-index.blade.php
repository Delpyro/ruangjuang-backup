<div class="container mx-auto px-4 py-6">
    <h2 class="text-3xl font-bold text-gray-800 mb-6">Ringkasan Transaksi Tryout & Bundle (Owner)</h2>
    ...
    @if (!empty($tryoutSummaries) && !$search && $topSalesCount > 0)
        ...
        <div class="mb-6 p-4 bg-white border-2 {{ $topBorderColor }} rounded-xl shadow-lg flex justify-between items-center transition-opacity duration-500">
            ...
            <div class="text-right">
                ...
                {{-- Memanggil fungsi goToDetail yang sudah terhubung dengan route Owner --}}
                <button wire:click="goToDetail('{{ $topItem['type'] }}', {{ $topItem['id'] }})"
                   class="text-xs text-blue-600 hover:text-blue-800 cursor-pointer font-semibold mt-1 block w-full text-right bg-transparent border-none p-0">
