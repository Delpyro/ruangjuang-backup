<div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl border border-gray-200">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Tambah Tryout Baru (Owner)</h2>
    ...
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
            <a href="{{ route('owner.tryouts.index') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition duration-200 font-medium flex items-center">
