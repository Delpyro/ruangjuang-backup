...
class UsersManage extends Component
{
    ...
    protected function rules()
    {
        $rules = [
            ...
            'role' => 'required|in:admin,user', // Owner bebas merubah role
    ...
    public function render()
    {
        ...
        return view('livewire.owner.users-manage', [
            'users' => $users,
        ])->layout('layouts.owner'); // ✨ Pastikan memanggil layout owner
    }
    ...
    public function edit($id)
    {
        ...
        $this->role = $user->role; // Owner mengambil role saat ini untuk di-edit
    ...
    public function update()
    {
        ...
        $updateData = [
            ...
            'email' => $this->email,
            'phone_number' => $this->phone_number,
            'role' => $this->role, // Owner bisa meng-update role
            'status' => $this->status,
            'is_active' => $this->is_active,
        ];
    ...
    // --- METHOD FORCE DELETE (KHUSUS OWNER) ---
