...
class BundlesEdit extends Component
{
    ...
    public function mount(Bundle $bundle) {
        $this->bundle = $bundle; 
        $this->title = $bundle->title; $this->slug = $bundle->slug; $this->description = $bundle->description; 
        $this->price = $bundle->price; $this->discount = $bundle->discount; $this->is_active = $bundle->is_active;
    ...
    public function updatedSelectedTryoutIds() { $allCount = $this->loadTryouts()->count(); $this->selectAll = count($this->selected_tryout_ids) === $allCount && $allCount > 0; }
    ...
    public function update() {
        ...
        } catch (\Exception $e) { session()->flash('error', 'Terjadi kesalahan: ' . $e->getMessage()); }
    }
    ...
    public function render() {
        return view('livewire.owner.bundles.bundles-edit', [ // View Owner
