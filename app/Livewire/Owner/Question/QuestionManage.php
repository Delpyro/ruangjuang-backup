...
namespace App\Livewire\Owner\Question;
...
class QuestionManage extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.owner.question.question-manage', [
            'questions' => $questions,
    ...
    // ✨ METHOD HAPUS PERMANEN (HANYA OWNER) ✨
    public function forceDeleteQuestion($id)
    {
        try {
            $question = Question::onlyTrashed()->findOrFail($id);
            // Hapus semua jawaban yang terkait (jika belum cascade delete di model)
            $question->answers()->delete(); 
            // Hapus paksa dari database
            $question->forceDelete();
            
            session()->flash('success', 'Question beserta jawabannya berhasil dihapus permanen.');
        } catch (\Exception $e) {
